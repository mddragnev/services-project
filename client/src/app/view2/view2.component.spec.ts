...
import { IgxIconModule, IgxInputGroupModule, IgxButtonModule, IgxRippleModule } from 'igniteui-angular';
...
describe('View2Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [ NoopAnimationsModule, FormsModule, IgxIconModule, IgxInputGroupModule, IgxButtonModule, IgxRippleModule ]
    })
    .compileComponents();
  });
